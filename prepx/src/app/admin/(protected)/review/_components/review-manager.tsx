...
export function ReviewManager({ data, examinationId, initialStatusFilter, initialSearch, isReadOnly, currentParams }: ReviewManagerProps): React.JSX.Element {
