      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
        ...
        {(searchValue || initialExamId || initialSchool) && (
          <button
            ...
            className="flex items-center justify-center gap-1.5 whitespace-nowrap rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-700"
          >
